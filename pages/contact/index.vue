<template>
  <section>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col">
          <div class="card" style="max-width: 32rem; margin: 10px auto">
            <div class="card-body">
                      ...
                      <div class="form-row">
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input id="frmFirstName" v-model="formData.firstName" name="first_name" type="text"
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input id="frmLastName" v-model="formData.lastName" name="last_name" type="text"
                      ...
                      <div class="form-row">
                        <div class="col-md-7 mb-3">
                          <div class="form-group">
                            ...
                            <input id="frmEmail" v-model="formData.email" name="user_email" type="email"
                        ...
                        <div class="col-md-5 mb-3">
                          <div class="form-group">
                            ...
                            <input id="frmSqFeet" v-model="formData.sqFeet" name="sq_feet" type="text"
                              class="form-control" placeholder="Square Feet" required />
                          </div>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="col-md-12 mb-3">
                          <div class="form-group">
                            ...
                            <textarea id="frmTextArea" v-model="formData.message" name="message" class="form-control"
                              rows="3"></textarea>
                          </div>
                        </div>
                      </div>
